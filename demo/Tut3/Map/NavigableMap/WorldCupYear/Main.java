package demo.Tut3.Map.NavigableMap.WorldCupYear;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.printf("%nThe first year of the World Cup after 1938: " +
                "%n", year1);
    ...
    public static void printMap(@NotNull Map<Integer, String> map){
